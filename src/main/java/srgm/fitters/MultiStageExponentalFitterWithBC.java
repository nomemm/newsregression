...
public class MultiStageExponentalFitterWithBC extends AbstractCurveFitter {
	...
	private MultiStageExponentalFitterWithBC(double[] initialGuess,
	...
	public static MultiStageExponentalFitterWithBC create(int n) {
		return new MultiStageExponentalFitterWithBC(new double[4 * n], 1000,
				null);
	}

	public MultiStageExponentalFitterWithBC withFunction(
			ParametricUnivariateFunction f) {

		return new MultiStageExponentalFitterWithBC(initialGuess.clone(),
				maxIter, f);
	}

	public MultiStageExponentalFitterWithBC withStartPoint(double[] newStart) {
		return new MultiStageExponentalFitterWithBC(newStart.clone(), maxIter,
				FUNCTION);
	}
